        ...
        slimScroll: function(x) {
            ...
            return this.each(function() {
                ...
                if (f.parent().hasClass(_.wrapperClass)) {
                    ...
                    }), s(0, !0)) : "top" !== _.start && (s(w(_.start).position().top, null, !0), _.alwaysVisible || m.hide()), window.addEventListener ? (this.addEventListener("DOMMouseScroll", e, {passive: true}), this.addEventListener("mousewheel", e, {passive: true})) : document.attachEvent("onmousewheel", e)
                }
            }), this
        }
    }), w.fn.extend({
