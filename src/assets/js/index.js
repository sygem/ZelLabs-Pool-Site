...
$(function() {
    ...
    setTimeout(function() {
        ...
        if ($(this).width() < 1000) {
            $('#header2').removeClass().addClass('d-none');
        } else {
            $('#header2').removeClass();
        }
        if ($(this).width() < 600) {
            $('#header1 #white').removeClass().addClass('d-none');
        } else {
            $('#header1 #white').removeClass();
        }
        if ($(this).width() < 510) {
            $('#header1').removeClass().addClass('d-none');
        } else {
            $('#header1').removeClass();
        }

        if ($(this).width() < 320) {
            $('#notification-list').addClass('xsmall');
            $('#notification-list').removeClass('small');
        } else if ($(this).width() < 400) {
            $('.refresh').addClass('d-none');
            $('#notification-list').addClass('small');
            $('#notification-list').removeClass('xsmall');
        } else {
        ...
        if ($(this).width() < 320) {
            $('#navbarCalculator').addClass('d-none');
        } else {
            $('#navbarCalculator').removeClass('d-none');
        }
    ...
    $("#left-sidebar .sidebar-scroll").slimScroll({
        ...
        $("body").css("overflow-y",$("#rightbar").hasClass("open") ? "hidden" : "auto");
    ...
    }), $(".megamenu_toggle_sidebar").on("click", function() {
        $("#megamenu").toggleClass("open")
        if ($("#megamenu").hasClass("open")) {
            $('body').addClass('megamenu-open');
        } else {
